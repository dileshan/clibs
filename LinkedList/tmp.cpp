# 1 "/home/mkd/workspace/LinkedLists/src/BasicLinkedList.cpp"
# 1 "/home/mkd/workspace/LinkedLists//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/mkd/workspace/LinkedLists/src/BasicLinkedList.cpp"
...
# 2 "/home/mkd/workspace/LinkedLists/src/BasicLinkedList.cpp" 2
...
# 3 "/home/mkd/workspace/LinkedLists/src/BasicLinkedList.cpp" 2

# 1 "/home/mkd/workspace/LinkedLists/include/BasicLinkedList.h" 1
...
# 6 "/home/mkd/workspace/LinkedLists/include/BasicLinkedList.h" 2
...
# 7 "/home/mkd/workspace/LinkedLists/include/BasicLinkedList.h" 2
...
{
    public:
        BasicLinkedList<Type> ();

        virtual ~BasicLinkedList<Type>();
...
struct node {
    ...
    struct node *next;
        ...
        BasicLinkedList <Type> ( const BasicLinkedList<Type> &__BasicLinkedList__ )
        {
            list = __BasicLinkedList__.list;
        };


        void add ( Type new_data );
        void add ( struct node **head_ref, Type new_data );
        void push ( Type new_data );
        void push ( struct node **new_node, Type new_data );
        Type pop ( );
        ...
        BasicLinkedList<Type>& operator= ( const BasicLinkedList<Type> &__other_object__ );
...
# 5 "/home/mkd/workspace/LinkedLists/src/BasicLinkedList.cpp" 2

struct node *list;
struct node *head;
struct node *tail;

template<class Type> BasicLinkedList<Type>::BasicLinkedList()
{


    list = __null;
}
# 31 "/home/mkd/workspace/LinkedLists/src/BasicLinkedList.cpp"
template<class Type> BasicLinkedList<Type>::~BasicLinkedList()
{

    while( list->next != __null )
    {
        free( list );
        list = list->next;
    }
}
# 48 "/home/mkd/workspace/LinkedLists/src/BasicLinkedList.cpp"
template<class Type> BasicLinkedList<Type>& BasicLinkedList<Type>::operator= ( const BasicLinkedList<Type> &__other_object__ )
{
    struct node *previous_node = __null;
    while( __other_object__.list->next != __null )
    {
        struct node *new_copy_node = ( struct node* ) malloc ( sizeof ( struct node ) );

        if ( previous_node == __null )
            head = previous_node;

        new_copy_node->data = __other_object__.list->data;
        new_copy_node->next = __null;
...
template<class Type> void BasicLinkedList<Type>::add( Type new_data )
{
    add( &list, new_data );
}

template<class Type> void BasicLinkedList<Type>::add( struct node **head_ref, Type new_data )
{
    ...
    ((new_node == tail) ? static_cast<void> (0) : __assert_fail ("new_node == tail", "/home/mkd/workspace/LinkedLists/src/BasicLinkedList.cpp", 85, __PRETTY_FUNCTION__));

}

template<class Type> void BasicLinkedList<Type>::push( Type new_data )
{
    push( &list, new_data );
}
...
template<class Type> void BasicLinkedList<Type>::push( struct node **head_ref, Type new_data )
{
    struct node* new_node = ( struct node* ) malloc( sizeof( struct node ) );
    new_node->data = new_data;
    ...
    ((new_node == head) ? static_cast<void> (0) : __assert_fail ("new_node == head", "/home/mkd/workspace/LinkedLists/src/BasicLinkedList.cpp", 108, __PRETTY_FUNCTION__));
}




template<class Type> Type BasicLinkedList<Type>::pop()
{
    Type first_element_data;
...
template<class Type> size_t BasicLinkedList<Type>::size( )
{
    if ( list != head )
        list = head;
...
template<class Type>
void BasicLinkedList<Type>::print()
{
    if ( list != head )
        list = head;
...
# 1 "/home/mkd/workspace/LinkedLists/main.cpp"
# 1 "/home/mkd/workspace/LinkedLists//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/mkd/workspace/LinkedLists/main.cpp"
...
# 2 "/home/mkd/workspace/LinkedLists/main.cpp" 2
...
# 3 "/home/mkd/workspace/LinkedLists/main.cpp" 2
...
# 5 "/home/mkd/workspace/LinkedLists/include/BasicLinkedList.h" 2
# 1 "/usr/include/assert.h" 1 3 4
# 68 "/usr/include/assert.h" 3 4
extern "C" {
...
# 5 "/home/mkd/workspace/LinkedLists/main.cpp" 2

int main()
{
# 19 "/home/mkd/workspace/LinkedLists/main.cpp"
    BasicLinkedList<int> *listOB = new BasicLinkedList<int>( );
    ...
    BasicLinkedList<int> *copylist = listOB;
